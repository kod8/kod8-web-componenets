...
class namazVaktiMini extends HTMLElement {
  ...
  handleData(data) {
    for (var vakit in data[0].vakitler) {
      //todo date obj
      //this.vakitler[vakit].valueDateObj = data[0].vakitler[vakit];
      this.vakitler[vakit].value = data[0].vakitler[vakit];
    }
    //todo date obj
    //this.vakitler["imsak2"].valueDateObj = data[1].vakitler["imsak"];
    this.vakitler["imsak2"].value = data[1].vakitler["imsak"];
